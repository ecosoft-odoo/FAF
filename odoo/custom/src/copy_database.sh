...
echo "9. Update system parameter"
docker exec $postgres_container psql -U $postgres_user $database_test -c "update ir_config_parameter set key = 'ribbon.name' where key like 'ribbon.name%'"
