...
delete from ir_model_data where model = 'stock.location' and res_id not in (select id from stock_location);
delete from ir_model_data where model = 'stock.picking.type' and res_id not in (select id from stock_picking_type);
delete from ir_model_data where model = 'stock.warehouse' and res_id not in (select id from stock_warehouse);
